...
def load_trained(load_filename, vocabulary):
    ...
    print('Logging Info - Embedding created from external file:{}, shape:{}, unknown tokens: {}'.format(load_filename,
                                                                                                        emb.shape,
                                                                                                        nb_unk))
...
# here we use a python implementation of Glove: `glove_python`, but the official glove implementation of C version
